...
const APPLY_OPERATIONS_DESCRIPTION = [
  ...
  "",
  "Nodes are sticky, text, image, or a shape: rectangle, ellipse, diamond,",
  "cylinder (a datastore), cloud (an external service), parallelogram (input or",
  "output), hexagon (a process), triangle (a decision) and actor (a person or",
  "role). Give x/y in board coordinates; width/height default sensibly per kind.",
  "",
